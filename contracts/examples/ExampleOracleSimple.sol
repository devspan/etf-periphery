...
contract ExampleOracleSimple {
    ...
    constructor(address factory, address tokenA, address tokenB) public {
        IEtfswapV2Pair _pair = IEtfswapV2Pair(EtfswapV2Library.pairFor(factory, tokenA, tokenB));
        pair = _pair;
        token0 = _pair.token0();
        token1 = _pair.token1();
    ...
    function update() external {
        (uint price0Cumulative, uint price1Cumulative, uint32 blockTimestamp) =
            EtfswapV2OracleLibrary.currentCumulativePrices(address(pair));
