...
contract ExampleSwapToPrice {
    ...
    IEtfswapV2Router01 public immutable router;
    address public immutable factory;

    constructor(address factory_, IEtfswapV2Router01 router_) public {
        factory = factory_;
        router = router_;
    }
    ...
    function swapToPrice(
        ...
        uint256 amountIn;
        {
            (uint256 reserveA, uint256 reserveB) = EtfswapV2Library.getReserves(factory, tokenA, tokenB);
            (aToB, amountIn) = EtfswapV2LiquidityMathLibrary.computeProfitMaximizingTrade(
